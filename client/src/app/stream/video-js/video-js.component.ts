...
export class VideoJsComponent implements OnDestroy, OnInit {
  ...
  ngOnInit() {
    ...
    axios.get('http://server.default.svc.cluster.local:3333/user', {
    ...
    // axios.get('/user', {
      ...
      this.stateUpdate({
          ...
          videoJsOptions: {
              ...
              controls: true,
              sources: [{
                  src: 'http://server.default.svc.cluster.local:' + config.rtmp_server.http.port + '/live/' + res.data.stream_key + '/index.m3u8',
